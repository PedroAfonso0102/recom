  ...
  <Layout>
    ...
    <div className={styles.centerData}>
      <ul className={styles.menuLateral}>
        ...
        <li className={`${styles.produto} ${styles.active}`}><Link to="/sugestoes-de-utilizacao">Sugestões de Utilização</Link></li>
        ...
        <table className={styles.productTable}>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>*Evite utilizar ferramentas onde há a possibilidade de ignição de fogo e incêndio. *Tenha certeza da localização dos extintores de incêndio quando não usar refrigeração à base de óleo solúvel.</td>
            </tr>
            <tr>
              <td></td>
            ...
            <tr>
              <td></td>
              <td>Fixar insertos e componentes com força excessivas através do uso de extensões e canos podem quebrá-los e expeli-los.</td>
