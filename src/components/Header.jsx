    ...
    <>
      ...
      <ul className={styles.headerMenu}>
        <div className={styles.menuCenter}>
          ...
          <li>
            <Link to="/produtos">Produtos</Link> <span className={styles.legend}>Conteúdo técnico</span>
          </li>
          <li>
            <Link to="/catalogo">Catálogo</Link> <span className={styles.legend}>Linha de produtos</span>
          </li>
          <li>
